...
module BackgroundQueue::ClientLib
  ...
  module Command
    ...
    def self.add_task_command(worker, owner_id, job_id, task_id, task_parameters={}, options={} )
      BackgroundQueue::Command.new(:add_task, options, :worker=>worker, :owner_id=>owner_id, :job_id=>job_id, :task_id=>task_id, :params=>task_parameters)
    end
    ...
    def self.add_tasks_command(worker, owner_id, job_id, tasks, shared_parameters={}, options={} )
      ...
      BackgroundQueue::Command.new(:add_tasks, options, :worker=>worker, :owner_id=>owner_id, :job_id=>job_id, :tasks=>tasks, :shared_parameters=>shared_parameters)
    end
